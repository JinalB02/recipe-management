...
import recipe.api.response.CreateEntityResponse;
import recipe.api.response.IngredientResponse;
...
public class IngredientController {
    ...
    public IngredientResponse getIngredient(@ApiParam(value = "Ingredient ID", required = true)
    ...
    public CreateEntityResponse createIngredient(@ApiParam(value = "Properties of the Ingredient", required = true)
    ...
    public void deleteIngredient(@ApiParam(value = "ingredient ID", required = true) @NotNull(message = "{id.notNull}")
